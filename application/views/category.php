                    ...
                    <?php  foreach ($data_ex as $data){
                      ...
                      if($data['public_view']=='0'){
                        ...
                        <li class="card inter-list-panel">
                          ...
                          <?php
                          if($data['uplaod_type']=='csv'){ //Point and line check
                            ...
                            if($data['style']==NULL){ //style null check
                              ...
                              $key_arr=json_decode($data['style'],TRUE);

                              if(array_key_exists('icon',$key_arr)){ //style circle or marker check

                                $mrk_icon=json_decode($data['style'],TRUE)['icon'];
                                $mark_div='<img src="'.$mrk_icon.'" class="mrker-icon">';
                            ...
                            if($data['style']==NULL){ //style null check
                              ...
                              $poly=json_decode($data['style'],TRUE);
                              $filcolor=ltrim($poly['fillColor'],'#');
                              $filopacity=$poly['fillOpacity'];
                      ...
                      <label for="<?php echo $data['category_table']?>" id="<?php echo $data['category_table']?>_sub" class="specific">
                        ...
                        <?php echo $mark_div  ?> <p style="display:inline-block;"><?php echo $data['category_name']; ?></p>
            ...
            if($data['uplaod_type']=='csv'){ //Point and line check
              ...
              if($data['style']==NULL){ //style null check
                ...
                if(array_key_exists('icon',$key_arr)){ //style circle or marker check
                  ...
                  $mark_div='<div class="dot" style=" height: 12px;width: 12px;background-color:blue;opacity:1;border-radius: 50%;display: inline-block;margin-left:5px; border:1px solid black"></div>';
